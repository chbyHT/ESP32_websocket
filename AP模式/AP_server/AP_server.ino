...
const char* ssid = "ESP32_Server";           //作為AP的WiFi ID
const char* password = "12345678";           //作為AP的WiFi 密碼
...
void setup(void) {
  ...
  Serial.begin(115200);
  WiFi.softAP(ssid, password);    //設定AP ID&密碼
  
  Serial.println("");
  IPAddress IP = WiFi.softAPIP();
  Serial.print("AP IP address: ");
  Serial.println(IP);             //印出server的ip
